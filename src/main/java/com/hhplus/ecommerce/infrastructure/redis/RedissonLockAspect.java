...
import com.hhplus.ecommerce.support.TransactionLogger;
...
public class RedissonLockAspect {
    ...
    @Around("@annotation(com.hhplus.ecommerce.infrastructure.redis.RedissonLock)")
    public void redissonLock(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        TransactionLogger.plusLockTryCnt();
